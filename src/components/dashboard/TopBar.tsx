    ...
    <header className="h-16 border-b border-slate-700 bg-slate-800 flex items-center justify-between px-4 shrink-0">
        ...
        <div className="hidden md:flex items-center gap-4 text-xs">
            <div className="flex items-center gap-2 bg-slate-900/50 px-3 py-1.5 rounded-full border border-slate-700">
                ...
                <span className="text-brand font-medium">LIVE</span>
                <span className="text-slate-400 ml-1 font-mono">00:02:45</span>
            </div>
            
            <div className="flex items-center gap-3 bg-slate-900/50 px-3 py-1.5 rounded border border-slate-700">
                <Network className="text-brand w-4 h-4" />
                <div className="flex flex-col">
                    <span className="font-medium text-slate-200">M32 <span className="text-slate-400 text-xxs font-normal">CONNECTED</span></span>
            ...
            <div className="flex items-center gap-3 bg-slate-900/50 px-3 py-1.5 rounded border border-slate-700">
                ...
                <div className="flex flex-col">
                    ...
                    <span className="text-xxs text-slate-500">4.2 ms</span>
                </div>
            </div>
